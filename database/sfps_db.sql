...
CREATE TABLE `student_ef_list` (
  ...
  `cet_schedule` datetime DEFAULT NULL,
  `mgt_start_date` date DEFAULT NULL,
  `mgt_end_date` date DEFAULT NULL,
...
--
-- Table structure for table `student_proctor`
--

CREATE TABLE `student_proctor` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `student_proctor`
--

INSERT INTO `student_proctor` (`id`, `student_id`, `proctor_id`, `date_created`) VALUES
(1, '1', '1', '2025-05-17 05:44:37');
...
--
-- Indexes for table `student_proctor`
--
ALTER TABLE `student_proctor`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `student_proctor`
--
ALTER TABLE `student_proctor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

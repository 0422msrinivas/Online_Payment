					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$student = $conn->query("SELECT * FROM proctor order by name asc ");
...
<script>
	...
	$('#new_student').click(function(){
		uni_modal("New Student ","manage_proctor.php","mid-large")
		
	})
	$('.edit_student').click(function(){
		uni_modal("Manage Student  Details","manage_proctor.php?id="+$(this).attr('data-id'),"mid-large")
	...
	function delete_student($id){
		start_load()
		$.ajax({
			url:'ajax.php?action=delete_proctor',
			method:'POST',
			data:{id:$id},
